...
// Definiere einen Typ für die Eigenschaften eines Team-Mitglieds
interface TeamMember {
    ...
    telephone: string;
    imageUrl: string;
    altText?: string; // Optional, falls kein alt-Text vorhanden ist
}
...
export default function Team({ people }: TeamProps) {
    return (
        <div>
            <h2 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-4xl mb-6">
                Unser Team
            </h2>
